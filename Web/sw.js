...
const CACHE = "treadway-shell-v20";
const SHELL = ["./", "index.html", "privacy.html", "setup.html", "styles.css", "insight-engine.js", "app.js", "config.js", "manifest.webmanifest", "icon.svg", "icon-180.png", "icon-192.png", "icon-512.png"];
